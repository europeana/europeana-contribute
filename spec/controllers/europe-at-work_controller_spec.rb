  ...
  describe 'POST create' do
    context 'with valid params' do
      ...
      it 'redirects to index' do
        post :create, params: params
        expect(response).to redirect_to(action: :index, c: 'eu-europe-at-work')
      end
  ...
  describe 'PUT update' do
    ...
    context 'when AASM event changed' do
      ...
      it 'fires AASM event' do
        ...
        expect(response).to redirect_to(controller: :contributions, action: :index, c: 'eu-europe-at-work')
