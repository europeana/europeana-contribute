      ...
      mustache[:content] ||= begin
        {
          ...
          previews: [
            ...
            preview_data(4, button_opens_form: false, button_text: t('preview_4.button_text'), url: 'https://www.europeana.eu/portal/collections/migration/collection-days.html')
          ]
        }
      end
    end
