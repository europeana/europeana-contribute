...
module EDM
  class Place
    ...
    has_one :dcterms_spatial_place_for, class_name: 'EDM::ProvidedCHO', inverse_of: :dcterms_spatial_places, dependent: :nullify
    has_one :edm_happenedAt_for, class_name: 'EDM::Event', inverse_of: :edm_happenedAt, dependent: :nullify
