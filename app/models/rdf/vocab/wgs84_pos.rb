...
module RDF::Vocab
  ...
  #   class WGS84_POS < RDF::StrictVocabulary
  #   end
  class WGS84_POS < RDF::StrictVocabulary('http://www.w3.org/2003/01/geo/wgs84_pos#')
    # Ontology definition
   ...
   sameThing\(P1, P2\) :- type\(P1, Point\), type\(P2, Point\), spaciallyIntersects\(P1, P2\).
         ...
         label: 'point',
         subClassOf: 'wgs84_pos:SpatialThing',
         type: 'rdfs:Class'
    term :SpatialThing,
    ...
    property :location,
        ...
        an accuracy appropriate for the size of the object and uses such as mapping .
             ...
             label: 'location',
             range: 'wgs84_pos:SpatialThing',
             subPropertyOf: 'foaf:based_near',
             type: 'rdf:Property'
    property :long,
